...
const TodoPage=()=>{
  ...
  console.log(Nm_user)
    ...
    const getApi=async ()=>{
      ...
      const response=await fetch('https://render-856a.onrender.com/todos',options);
    ...
    const delFunc=async (idVal)=>{
        ...
        const options={
         ...
         const response=await fetch(`https://render-856a.onrender.com/todos/${idVal}`,options)
    ...
    const delUserApi=await fetch(`https://render-856a.onrender.com/delUser/${User_idn}`,options)
    ...
    const updateApi=async (ident,updObj)=>{
      ...
      const response=await fetch(`https://render-856a.onrender.com/todos/${ident}`,options)
  ...
  const getUserDetailsFunc=async ()=>{
    ...
    const pApi=await fetch(`https://render-856a.onrender.com/profileInfo/${User_idn}`,options)
